...
bool PacketDisassembler::DisasmPacketType3(const uint8_t* base_ptr, uint32_t packet,
                                           PacketInfo* out_info) {
  static constexpr PacketTypeInfo type_3_unknown_info = {PacketCategory::kGeneric, "PM4_TYPE3_UNKNOWN"};
  ...
  switch (opcode) {
    ...
    case PM4_INTERRUPT: {
      ...
      intaction.gen_interrupt.cpu_mask = memory::load_and_swap<uint32_t>(ptr + 0);
    ...
    case PM4_XE_SWAP: {
      ...
      xsa.xe_swap.frontbuffer_ptr = memory::load_and_swap<uint32_t>(ptr + 0);
    ...
    case PM4_INDIRECT_BUFFER_PFD: {
      ...
      iba.indir_buffer.list_ptr = memory::load_and_swap<uint32_t>(ptr);
      iba.indir_buffer.list_length = memory::load_and_swap<uint32_t>(ptr + 4);
    ...
    case PM4_WAIT_REG_MEM: {
      ...
      wrm.wait_info = memory::load_and_swap<uint32_t>(ptr + 0);
      wrm.poll_reg_addr = memory::load_and_swap<uint32_t>(ptr + 4);
      wrm.ref = memory::load_and_swap<uint32_t>(ptr + 8);
      wrm.mask = memory::load_and_swap<uint32_t>(ptr + 12);
      wrm.wait = memory::load_and_swap<uint32_t>(ptr + 16);
    ...
    case PM4_REG_RMW: {
      ...
      rmw.and_mask = memory::load_and_swap<uint32_t>(ptr + 4);
      rmw.or_mask = memory::load_and_swap<uint32_t>(ptr + 8);
    ...
    case PM4_COND_WRITE: {
      ...
      cwr.wait_info = memory::load_and_swap<uint32_t>(ptr + 0);
      cwr.poll_reg_addr = memory::load_and_swap<uint32_t>(ptr + 4);
      cwr.ref = memory::load_and_swap<uint32_t>(ptr + 8);
      cwr.mask = memory::load_and_swap<uint32_t>(ptr + 12);
      cwr.write_reg_addr = memory::load_and_swap<uint32_t>(ptr + 16);
      cwr.write_data = memory::load_and_swap<uint32_t>(ptr + 20);
    ...
    case PM4_EVENT_WRITE: {
      ...
      evw_action.event_write.initiator = memory::load_and_swap<uint32_t>(ptr + 0);
    ...
    case PM4_EVENT_WRITE_SHD: {
      ...
      evws.initiator = memory::load_and_swap<uint32_t>(ptr + 0);
      evws.address = memory::load_and_swap<uint32_t>(ptr + 4);
      evws.value = memory::load_and_swap<uint32_t>(ptr + 8);
    ...
    case PM4_SET_SHADER_CONSTANTS: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_SET_SHADER_CONSTANTS"};
      out_info->type_info = &op_info;
      uint32_t offset_type = memory::load_and_swap<uint32_t>(ptr + 0);
      uint32_t index = offset_type & 0xFFFF;
    ...
    case PM4_CONTEXT_UPDATE: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_CONTEXT_UPDATE"};
      out_info->type_info = &op_info;
      uint32_t value = memory::load_and_swap<uint32_t>(ptr);
      PacketAction ctxu;
    ...
    case PM4_WAIT_FOR_IDLE: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_WAIT_FOR_IDLE"};
      out_info->type_info = &op_info;
      uint32_t value = memory::load_and_swap<uint32_t>(ptr);
      PacketAction wfi;
    ...
    case PM4_VIZ_QUERY: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_VIZ_QUERY"};
      out_info->type_info = &op_info;
      uint32_t value = memory::load_and_swap<uint32_t>(ptr);
    ...
    case PM4_EVENT_WRITE_ZPD: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_EVENT_WRITE_ZPD"};
      out_info->type_info = &op_info;
      uint32_t value = memory::load_and_swap<uint32_t>(ptr);
    ...
    case PM4_MEM_WRITE: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_MEM_WRITE"};
      out_info->type_info = &op_info;
      PacketAction mwr;
      mwr.type = Type::kMemWrite;
      mwr.words.reserve(count - 1);

      uint32_t write_addr = memory::load_and_swap<uint32_t>(ptr);
      ...
      for (uint32_t i = 0; i < count - 1; i++) {
        uint32_t write_data = memory::load_and_swap<uint32_t>(&ptr[(i + 1) * 4]);
    ...
    case PM4_REG_TO_MEM: {
      static constexpr PacketTypeInfo op_info = {PacketCategory::kGeneric, "PM4_REG_TO_MEM"};
      out_info->type_info = &op_info;
      PacketAction r2m;
      r2m.type = Type::kRegToMem;
      r2m.reg2mem.reg_addr = memory::load_and_swap<uint32_t>(ptr);
      uint32_t dword1 = memory::load_and_swap<uint32_t>(ptr + 4);
